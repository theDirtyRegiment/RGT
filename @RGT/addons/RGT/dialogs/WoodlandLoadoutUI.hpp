class WoodlandLoadoutUI
{
	...
	class controls
	{
		...
		class RscButton_1600: RscButton
		{
			...
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_ARAmmoBearerwd', player, false]";
		};
		class RscButton_1601: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_GrenadierAmmoBearerwd', player, false]";
		};
		...
		class RscButton_1612: RscButton
		{
			...
			colorBackground[] = {0.1,0.1,0.1,1};
			sizeEx = 0.06;
			action = "remoteExec ['RGT_fnc_MGAmmoBearerwd', player, false]";
		};
	};
};
