...
hint "You're a SOF commander. \nYour team is in non-attributable clothing for false flag ops. \n \nPROs: Your team can ditch gear and blend in with the populace when needed. \n \nCONs: Not equipped for heavy firefights.";