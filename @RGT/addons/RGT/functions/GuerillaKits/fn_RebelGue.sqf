...
player addWeapon "rhs_weap_l1a1_wood";
...
for "_i" from 1 to 8 do {player addItem "rhs_mag_20Rnd_762x51_m62_fnfal";};
...
hint "You're a rebel equipped with only small arms.";