...
hint "You're now equipped as Russian spetsnaz with an disposable single-shot RPG-26, that is an extremely light and effective weapons against lightly armored vehicles, but is tricky to aim with.";