...
_vest = [
	...
	"milgp_v_marciras_teamleader_rgr"] call BIS_fnc_selectRandom;
_bag = [
...
for "_i" from 1 to 6 do {player addItem "rhs_VOG25";};
for "_i" from 1 to 2 do {player addItem "rhs_VOG25P";};
for "_i" from 1 to 2 do {player addItem "rhs_GDM40";};
...
hint "You're now equipped as a Russian spetsnaz commander. \nYour equipment is optimized to provide the leadership, that your team needs. \nKeep your guys safe, through proper planning and leadership, товарищ! \n \nPROs: Your team is equipped for hostage rescue and direct action raids. \n \nCONs: Your team is not equipped to deal with hostages or prisoners.";