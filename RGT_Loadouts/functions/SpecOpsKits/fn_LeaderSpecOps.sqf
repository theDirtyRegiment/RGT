...
_rifle = [
	...
	"rhs_weap_hk416d15_smr_tan_kac", 0.05,
	"rhs_weap_m4_nsr_d", 0.05,
...
hint "You're now equipped as a special operations commander. \nYour equipment is optimized to provide the leadership, that your team needs. \nKeep your guys safe, through proper planning and leadership! \n \nPROs: Your team is equipped for stealthy night-time and hostage rescue operations. \n \nCONs: They do not have the ammo for long firefights.";