...
_rifle = [
	...
	"rhs_weap_ak105_zenitco01"] call BIS_fnc_selectRandom;
_muzzle = [
	"rhs_acc_ak5", 0.40, 
	"rhs_acc_tgpa", 0.20, 
	"rhs_acc_dtk", 0.20, 
...
_optic = [
	"rhs_acc_ekp1", 
	"rhs_acc_ekp8_02", 
	"rhs_acc_pkas"] call BIS_fnc_selectRandom;
_medbag = [
	"TRYK_B_Medbag_BK",
	"USP_DELTA_BAG_BLK",
...
_grip = [
	...
	"rhsusf_acc_rvg_blk", 
	"rhsusf_acc_grip2", 
	"rhsusf_acc_tdstubby_blk"] call BIS_fnc_selectRandom;
_clothing = [
...
_vest = [
	...
	"milgp_v_marciras_medic_rgr"] call BIS_fnc_selectRandom;
_mag = [
...
player addItem "rhssaf_mag_brd_m83_green";
...
hint "You're now equipped as a Russian spetsnaz medic. \nKeep your guys safe and mission ready.";